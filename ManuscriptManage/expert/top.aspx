        ...
        <tr>
          <td height="35">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Label ID="lbluserName" runat="server"></asp:Label>
              您好！&nbsp;欢迎使用《安财学报》在线投稿系统&nbsp;&nbsp;&nbsp; <a class="STYLE1" href="#" language="javascript" onclick="if (confirm('确认要离开本系统?')){;href='../Default.aspx';target='_top';}">   安全退出</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="STYLE2">日期：</span><font color="#666666">
