...
<body>
  ...
  <TR>
    ...
    <TD background=../images/new_002.jpg><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tbody>
        <tr>
          <td height="35" valign="bottom"><FONT size=4><B>《安财学报》在线投稿系统 管理中心</B></FONT></td>
          </tr>
        <tr>
          <td height="35">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 主编您好，欢迎使用《安财学报》在线投稿系统&nbsp;&nbsp;&nbsp; <a class="STYLE1" href="#" language="javascript" onclick="if (confirm('确认要离开本系统?')){;href='../Default.aspx';target='_top';}">   安全退出</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="STYLE2">日期：</span><font color="#666666">
